fzqblog.letters = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"];
	fzqblog.chooseType = {
		type1: 1,
		type2: 2
	}
	$(document).ready(function() {
		...
		function loadAllExams(){
			$.ajax({
				...
				type: 'POST',
				dataType: 'json',
				data: {"categoryId": fzqblog.categoryId},
		...
		function ExamItem(data, i){
			...
			if (data.chooseType.type == fzqblog.chooseType.type1) {
				typetit = "单选";
			} else if (data.chooseType.type == fzqblog.chooseType.type2) {
				typetit = "多选";
			}
