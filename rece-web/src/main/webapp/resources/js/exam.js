$(document).ready(function() {
			...
			function examier(data){
				var a = $('<a href="' +  fzqblog.realpath + '/user/' + data.userId + '"></a>');
				var img = $('<img src="../resources/images/' + data.userIcon + '" class="img-circle" style="display:inline;width:80px;height: 80px;">').appendTo(a);
