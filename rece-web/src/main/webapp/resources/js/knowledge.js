$(document).ready(function() {
	$(".slowshow").click(function(event) {
		document.location.href = fzqblog.realpath + "/knowledge/pCategoryId/" + $(this).attr("pCategoryId");
	});
	...
	$("#publicKnowledgeBtn").click(function(event) {
		...
		document.location.href = fzqblog.realpath + "/knowledge/prePublicKnowledge";
	});
